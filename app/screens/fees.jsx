...
const fees = () => {
  ...
  const { user, branchId: branchIdRedux, schoolId: schoolIdRedux, classId: classIdRedux } = useSelector((state) => state.auth);
        ...
        <View style={styles.header}>
          <View style={styles.headerContent}>
            <Text style={styles.headerTitle}>
              {studentName ? `${studentName}'s Fees` : "Student Fees"}
            </Text>
