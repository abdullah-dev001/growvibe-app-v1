...
const principals = () => {
  ...
  } = useGetPrincipalsByBranchQuery(branchId, {
    skip: !branchId,
  ...
  const handleDelete = (principal) => {
    Alert.alert(
      "Delete Principal",
      `Are you sure you want to delete "${principal.full_Name}"? This action cannot be undone.`,
      [
                ...
                >
                  ...
                  <View style={styles.cardActions}>
                    ...
                    <View style={styles.primaryActions}>
                      ...
                      <TouchableOpacity
                        onPress={() => handleDelete(principal)}
